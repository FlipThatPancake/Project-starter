...
<!-- adapted from github:mattpocock/skills — skills/productivity/grilling; added the explicit-announce rule per user ruling 2026-07-07 (active every session, self-fires on judgment, but must say so) -->
