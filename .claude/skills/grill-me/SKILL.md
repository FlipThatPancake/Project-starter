...
If a *fact* can be found by exploring the codebase, look it up rather than asking me — but stay within the current session's scope (its read-set) while doing so; only reach beyond it when doing so is clearly warranted for the question at hand, or I've said so explicitly. The *decisions*, though, are mine — put each one to me and wait for my answer.
